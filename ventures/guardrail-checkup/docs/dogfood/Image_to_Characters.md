# Agent guardrail checkup — Image\_to\_Characters

Run 2026-07-27 · read-only · `Image_to_Characters` · HEAD `311d39283b55`
...
- **Repository:** `Image_to_Characters`, as given on the command line
- **HEAD:** `311d39283b55ce608ca3f0c83786e35675b39ac5`
- **Size:** 6 file(s) considered, 25,957,911 bytes (apparent size)
...
- **Command:** `guardrail-checkup run Image_to_Characters --out docs/dogfood/Image_to_Characters.md`
- **Repository commit:** `311d39283b55ce608ca3f0c83786e35675b39ac5`
