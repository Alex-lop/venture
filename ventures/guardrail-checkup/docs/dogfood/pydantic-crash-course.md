# Agent guardrail checkup — pydantic-crash-course

Run 2026-01-24 · read-only · `pydantic-crash-course` · HEAD `a1e6d2b4574c`
...
- **Repository:** `pydantic-crash-course`, as given on the command line
- **HEAD:** `a1e6d2b4574c177e53a303e03f75353d85c2907f`
- **Size:** 15 file(s) considered, 164,208 bytes (apparent size)
...
| --- | --- | --- |
| CLAUDE.md: 2,605 bytes, 65 lines, 2 line(s) forbid something and name a path | `CLAUDE.md:24` | prose an agent may follow; nothing here blocks a write, so it is guidance, not a guardrail |
...
- **Command:** `guardrail-checkup run pydantic-crash-course --out docs/dogfood/pydantic-crash-course.md`
- **Repository commit:** `a1e6d2b4574c177e53a303e03f75353d85c2907f`
