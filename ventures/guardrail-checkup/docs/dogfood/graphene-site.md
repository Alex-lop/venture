# Agent guardrail checkup — graphene-site

Run 2026-08-28 · read-only · `graphene-site` · HEAD `b395e557dcf4`
...
- **Repository:** `graphene-site`, as given on the command line
- **HEAD:** `b395e557dcf46995e17ddc45d40e75f9217e4a71`
- **Size:** 18 file(s) considered, 308,562 bytes (apparent size)
...
- **Command:** `guardrail-checkup run graphene-site --out docs/dogfood/graphene-site.md`
- **Repository commit:** `b395e557dcf46995e17ddc45d40e75f9217e4a71`
- **Repair commits examined:** 2, from the last 2000 non-merge commits
