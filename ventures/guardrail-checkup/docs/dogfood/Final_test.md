# Agent guardrail checkup — Final\_test

Run 2026-09-02 · read-only · `Final_test` · HEAD `3c207b0430a6`
...
- **Repository:** `Final_test`, as given on the command line
- **HEAD:** `3c207b0430a672cdc36e2a6a106efe5d929a934a`
- **Size:** 4 file(s) considered, 176,077 bytes (apparent size)
...
- **Command:** `guardrail-checkup run Final_test --out dogfood/Final_test.md`
- **Repository commit:** `3c207b0430a672cdc36e2a6a106efe5d929a934a`
