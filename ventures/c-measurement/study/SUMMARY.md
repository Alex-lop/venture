...
run complete · revised after a three-team red-team pass.** Full study: `WRITEUP.md` (its
§Red-team pass lists every objection and its disposition). Method: `METHOD.md`. Data:
`DATASET-CARD.md`.
...
- **Not a question about PRs that ship no tests.** 288 of the 937 PRs examined (30.7%,
  ...
  from the tracked per-repo funnel `../corpus/funnel-v2.csv` (2,015 checkpoint rows deduped to
  1,908 repos, last row per repo; see `WRITEUP.md` §Corpus and funnel).
